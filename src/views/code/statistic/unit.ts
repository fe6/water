...
const base: ApiEntity = {
  title: '单位',
  desc: '通过前缀和后缀添加单位。',
  code: `<w-statistic title="Feedback" v-model="value1" style="display:inline-block">
  <w-icon slot="prefix">
...
<w-statistic title="Unmerged" v-model="value1" style="margin-left: 32px;display:inline-block">
