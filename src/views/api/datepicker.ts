...
export const props = [
  ...
  },
  {
    param: 'placement',
    desc:
      '气泡框位置，可选 <code>top</code> 、 <code>bottom</code> 、 <code>topLeft</code> <br> <code>topRight</code> 、 <code>bottomLeft</code> 、 <code>bottomRight</code> 。',
    type: 'String',
    require: '否',
    default: 'top',
  },
  ...
  },
  {
    param: 'getContainer',
    desc:
      '浮层渲染父节点，默认渲染到 body 上。支持返回 <code> Promise </code>。支持返回 <code> Promise </code>',
    type: 'Function',
    require: '否',
