...
describe('Select.vue', () => {
  let testFn: any = null;
  let testSelectClick: any = null;
  let testSelectDisabledClick: any = null;
  let testFieldDelete: any = null;
  let testToggleNewTag: any = null;
  let testFieldEnter: any = null;
  let testFieldNoValueEnter: any = null;
  let testFieldInput: any = null;
  let testSearchEnter: any = null;
  let testSearchNoValueEnter: any = null;
  let testUpdateHock: any = null;
  let testNoUpdateHock: any = null;
  let testNoName: any = null;
  let testName: any = null;
  let testGetFocus: any = null;
  let testOptions: any = null;
  ...
  beforeEach(() => {
    ...
    testOptions = shallowMount(Select, {
      propsData: {
        value: '苹果',
        options,
      },
    });
    testGetFocus = shallowMount(Select, {
      propsData: {
        mode: 'tag',
        search: true,
      },
  ...
  it('test fieldEnter', (done) => {
    testFieldEnter.vm.$nextTick(() => {
      try {
        ...
        testFieldEnter.vm.$nextTick(() => {
          expect(resetHoverIndexFn).toBeCalled();
          expect(testFieldEnter.vm.fieldValue).toBe('');
          testFieldEnter.vm.optHoverIndex = 0;
          testFieldEnter.vm.fieldEnter({ target: { value: testTip } });
          done();
        });
      } catch (err) {
  ...
  it('test fieldInput', (done) => {
    testFieldInput.vm.$nextTick(() => {
      try {
        ...
        testFieldInput.vm.$nextTick(() => {
          expect(testFieldInput.vm.fieldWidth).toBe('20px');
          expect(resetHoverIndexFn).toBeCalled();
        });
  ...
  it('test no title', (done) => {
    testNoName.vm.$nextTick(() => {
      try {
        expect(testNoName.vm.title).toEqual([]);
        done();
      } catch (err) {
        done.fail(err);
      }
  ...
  it('test string title', (done) => {
    testName.vm.$nextTick(() => {
      try {
        expect(testName.vm.title).toBe('tag');
        done();
      } catch (err) {
        done.fail(err);
      }
  ...
  it('test getFocus', (done) => {
    testGetFocus.vm.$nextTick(() => {
      try {
        testGetFocus.vm.getFocus();
        done();
      } catch (err) {
        done.fail(err);
      }
