<template>
  <div class="w-input-number" :class="{
...
export default class InputNumber extends Vue {
  ...
  @Model('model', { type: [Number, String], default: 0 }) readonly value!: number | string;
  ...
  get animatedNumber(): number | string {
    const writeValue = formatWrapper(this.tweenedNumber, this.formatter, this.parser);
